...
const HeroSection: React.FC<HeroSectionProps> = ({ onScrollToComparisons }) => {
  return (
    <section className="bg-gradient-to-r from-brand-primary to-brand-primary-light text-primary-foreground py-16 px-4" role="banner">
      <div className="container mx-auto text-center max-w-4xl">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
          <Button 
            size="lg" 
            className="bg-background text-brand-primary hover:bg-background/90 px-8 py-3 text-lg font-semibold shadow-lg"
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          <div className="space-y-2">
            ...
            <div className="text-sm text-primary-foreground/80">Productos</div>
          </div>
          <div className="space-y-2">
            <div className="text-2xl font-bold">50+</div>
            <div className="text-sm text-primary-foreground/80">Tiendas</div>
          </div>
          <div className="space-y-2">
            <div className="text-2xl font-bold">15+</div>
            <div className="text-sm text-primary-foreground/80">Categorías</div>
          </div>
          <div className="space-y-2">
            <div className="text-2xl font-bold">CDMX</div>
            <div className="text-sm text-primary-foreground/80">Cobertura</div>
          </div>
        </div>
      </div>
    </section>
